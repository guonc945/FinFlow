...
const MainLayout = () => {
    const getPageTitle = useCallback((pathname: string) => {
        const titles: Record<string, { title: string; subtitle?: string }> = {
            ...
            '/reports': { title: '数据中心', subtitle: '统一管理外部连接、数据集模型与数据应用定义' },
            '/oa-center': { title: '泛微协同', subtitle: '作为泛微相关能力的独立入口，承接后续协同与流程集成页面' },
            '/report-center': { title: '报表中心', subtitle: '作为最终报表查看、分析与汇总展示的统一入口' },
            '/integrations/reporting': { title: '数据中心', subtitle: '统一管理外部连接、数据集模型与报表定义' },
            '/integrations/data-center': { title: '数据中心', subtitle: '统一管理外部连接、数据集模型与报表定义' },
            '/integrations/data-center/connections': { title: '数据连接', subtitle: '管理外部数据库连接、Schema 与结构浏览能力' },
            '/integrations/data-center/datasets': { title: '数据建模', subtitle: '管理 SQL 数据集模型、参数模板与校验结果' },
            '/integrations/data-center/applications': { title: '报表设计', subtitle: '管理面向业务的报表定义、筛选器与图表配置' },
            '/integrations/data-center/dictionaries': { title: '业务字典', subtitle: '统一管理人工维护字典与动态字典来源，集中承接业务映射能力' },
            '/integrations/data-center/categories': { title: '报表分类', subtitle: '以树形结构组织报表分类，便于快速定位和管理' },
            '/integrations/data-sync-schedules': { title: '数据同步', subtitle: '独立管理马克与金蝶基础资料同步的定时计划、执行频率与运行记录' },
            '/integrations/voucher-push-schedules': { title: '凭证推送', subtitle: '独立管理收款单凭证自动推送的定时计划、账簿范围与执行记录' },
            '/integrations/sync-schedules': { title: '数据同步', subtitle: '独立管理马克与金蝶基础资料同步的定时计划、执行频率与运行记录' },
