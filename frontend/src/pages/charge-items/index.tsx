...
import type { ChargeItem, Project } from '../../types';
...
const ChargeItems = () => {
    ...
    const columns = [
        ...
        { key: 'period_type_str' as keyof ChargeItem, title: '周期规则', width: 180 },
        {
            ...
            render: (val: unknown) => val && typeof val === 'object' ? (
                <div className="flex flex-col">
                    ...
                    <span className="text-xs text-slate-400 font-mono">{String((val as { number?: unknown }).number || '')}</span>
                </div>
        ...
        },
        {
            ...
            title: '同步时间',
            width: 120,
            render: (val: unknown) => new Date(String(val)).toLocaleDateString()
        },

        {
            ...
            title: '操作',
            width: 80,
            render: (_value: unknown, item: ChargeItem) => (
    ...
    return (
        <div className="page-container fade-in charge-items-page">
