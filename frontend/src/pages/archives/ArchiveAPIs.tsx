...
type ArchiveConfig = {
    ...
    url_path?: string;
    request_body?: string;
    request_headers?: string | Record<string, unknown>;
    [key: string]: unknown;
};
...
const ArchiveAPIs = () => {
    ...
    const [testResult, setTestResult] = useState<ArchiveTestResult>(null);
                                            ...
                                            <div className="form-field">
                                                ...
                                                <div className="select-with-status">
                                                    <Select
                                                        ...
                                                        value={typeof config.service_id === 'number' || typeof config.service_id === 'string' ? config.service_id : ''}
                                                        onChange={(v) => setConfig({ ...config, service_id: v ? Number(v) : undefined })}
                                                        options={[
                                                            { value: '', label: '-- 未关联任何服务 --' },
                                                            ...services.map(s => ({ value: String(s.id), label: s.display_name || s.service_name })),
                                                        ]}
                                                    />
                                                    {Boolean(config.service_id) && (
                                        ...
                                        <div className="section-card">
                                            ...
                                            <div className="endpoint-compact-row">
                                                ...
                                                <div className="url-input-col">
                                                    ...
                                                    <input
                                                        ...
                                                        value={typeof config.url === 'string' ? config.url : (typeof config.url_path === 'string' ? config.url_path : '')}
                                            ...
                                            <div className="compact-url-preview">
                                                ...
                                                <div className="preview-url-text">
                                                    {typeof config.url === 'string' && config.url ? config.url : '等待输入接口地址...'}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div className="test-stats-grid">
                                                        <div className={`stat-card ${testResult.success ? 'success' : 'error'}`}>
                                                            ...
                                                            <div className="stat-value">
                                                                ...
                                                                {String(testResult.status_code || 'Err')}
                                                            </div>
                                                        </div>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="form-field">
                                ...
                                <Select
                                    ...
                                    options={[
                                        { value: 'FileText', label: '📄 文本列表 (FileText)' },
                                        { value: 'Layout', label: '📊 数据布局 (Layout)' },
                                        { value: 'Globe', label: '🌐 远程同步 (Globe)' },
                                        { value: 'Settings', label: '⚙️ 配置项 (Settings)' },
                                    ]}
                                />
                            </div>
                        </div>
