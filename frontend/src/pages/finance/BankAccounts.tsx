...
const BankAccounts = () => {
    ...
    const fetchAccounts = async () => {
        ...
        try {
            ...
            const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/finance/kd-bank-accounts`, {
                params: {
                    skip: skip,
                    limit: pageSize,
    ...
    const handleSync = async () => {
        ...
        setLoading(true);
        try {
            await axios.post(`${import.meta.env.VITE_API_BASE_URL}/finance/kd-bank-accounts/sync`, {});
