...
const Parks = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            title: '车位信息',
            render: (val: unknown, row: Park): ReactNode => (
        ...
        },
        {
            ...
            title: '持有人/租户',
            render: (val: unknown) => val ? String(val) : <span className="text-secondary">-</span>
        },
        {
        ...
        },
        {
            ...
            title: '财务系统房号映射',
            width: 220,
            render: (_value: unknown, row: Park): ReactNode => (
                <div
    ...
    return (
        <div className="page-container fade-in parks-page">
