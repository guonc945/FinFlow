...
import {
  ...
  ChargeItems,
  DataCenterIndex,
  DataCenterConnectionsPage,
  DataCenterDatasetsPage,
  DataCenterApplicationsPage,
  DataCenterDictionariesPage,
  DataCenterCategoriesPage,
  OACenterPage,
  ReportCenterPage,
  Settings,
  Users,
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route path="/" element={<MainLayout />}>
            ...
            <Route path="report-center/:id" element={<MenuRoute menuKey="/report-center"><RouteElement variant="detail"><ReportCenterPage /></RouteElement></MenuRoute>} />
            <Route path="reports" element={<Navigate to="/integrations/data-center" replace />} />
            <Route path="integrations" element={<Navigate to="/integrations/data-center" replace />} />
            <Route path="integrations/reports" element={<Navigate to="/integrations/data-center" replace />} />
            <Route path="integrations/sync-schedules" element={<Navigate to="/integrations/data-sync-schedules" replace />} />
            <Route path="integrations/reporting" element={<Navigate to="/integrations/data-center" replace />} />
            <Route
              path="integrations/data-center"
              element={
                <MenuRoute
                  menuKey="/integrations/data-center"
                  fallbackMenuKeys={['/integrations/data-center']}
                  apiKey="reporting.manage"
                >
                  <RouteElement variant="dashboard"><DataCenterIndex /></RouteElement>
                </MenuRoute>
              }
            />
            <Route
              ...
              element={
                <MenuRoute
                  menuKey="/integrations/data-center/connections"
                  fallbackMenuKeys={['/integrations/data-center', '/integrations/reporting', '/integrations/data-center/connections']}
                  apiKey="reporting.manage"
                >
                  <RouteElement variant="dashboard"><DataCenterConnectionsPage /></RouteElement>
                </MenuRoute>
              }
            />
            <Route
              ...
              element={
                <MenuRoute
                  menuKey="/integrations/data-center/datasets"
                  fallbackMenuKeys={['/integrations/data-center', '/integrations/reporting', '/integrations/data-center/datasets']}
                  apiKey="reporting.manage"
                >
                  <RouteElement variant="dashboard"><DataCenterDatasetsPage /></RouteElement>
                </MenuRoute>
              }
            />
            <Route
              ...
              element={
                <MenuRoute
                  menuKey="/integrations/data-center/applications"
                  fallbackMenuKeys={['/integrations/data-center', '/integrations/reporting', '/integrations/data-center/applications']}
                  apiKey="reporting.manage"
                >
                  <RouteElement variant="dashboard"><DataCenterApplicationsPage /></RouteElement>
                </MenuRoute>
              }
            />
            <Route
              ...
              element={
                <MenuRoute
                  menuKey="/integrations/data-center/dictionaries"
                  fallbackMenuKeys={['/integrations/data-center', '/integrations/reporting', '/integrations/data-center/dictionaries']}
                  apiKey="reporting.manage"
                >
                  <RouteElement variant="dashboard"><DataCenterDictionariesPage /></RouteElement>
                </MenuRoute>
              }
            />
            <Route
              ...
              element={
                <MenuRoute
                  menuKey="/integrations/data-center/categories"
                  fallbackMenuKeys={['/integrations/data-center', '/integrations/reporting', '/integrations/data-center/categories']}
                  apiKey="reporting.manage"
                >
                  <RouteElement variant="dashboard"><DataCenterCategoriesPage /></RouteElement>
                </MenuRoute>
              }
            />
          ...
          {/* 数据应用全屏查看（新标签页打开，不包含侧边栏） */}
          <Route path="/report-viewer/:id" element={<RouteElement variant="detail"><ReportCenterPage /></RouteElement>} />
        </Route>
