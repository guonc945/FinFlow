...
from api.routers import business_dictionaries as business_dictionaries_router_module
...
def _log_app_startup() -> None:
    logger.info(
        "Backend startup complete. pid=%s host=%s port=%s reload=%s time=%s",
        os.getpid(),
        os.getenv("APP_HOST", "0.0.0.0"),
        os.getenv("APP_PORT", "8100"),
        os.getenv("APP_RELOAD", "false"),
...
def _log_app_shutdown() -> None:
    logger.info(
        "Backend shutdown begin. pid=%s time=%s",
        os.getpid(),
        datetime.now().isoformat(timespec="seconds"),
    )
...
app.include_router(business_dictionaries_router_module.router)
...
app.add_middleware(
    ...
    allow_origin_regex=(
        ...
        else r"^http://(localhost|127\.0\.0\.1|192\.168\.\d+\.\d+|10\.\d+\.\d+\.\d+|fn\.hyqy\.group)(:\d+)?$"
    ),
...
MENU_PERMISSION_DEFINITIONS = [
    ...
    {"key": "/integrations/reporting", "label": "数据中心", "section": "集成中心", "group": "数据中心", "required": False, "admin_only": False, "default_enabled": False},
    {"key": "/integrations/data-center", "label": "数据中心总览", "section": "集成中心", "group": "数据中心", "required": False, "admin_only": False, "default_enabled": False},
    {"key": "/integrations/data-center/connections", "label": "外部连接", "section": "集成中心", "group": "数据中心", "required": False, "admin_only": False, "default_enabled": False},
    {"key": "/integrations/data-center/datasets", "label": "数据集建模", "section": "集成中心", "group": "数据中心", "required": False, "admin_only": False, "default_enabled": False},
    {"key": "/integrations/data-center/applications", "label": "数据应用", "section": "集成中心", "group": "数据中心", "required": False, "admin_only": False, "default_enabled": False},
    {"key": "/integrations/data-center/categories", "label": "分类管理", "section": "集成中心", "group": "数据中心", "required": False, "admin_only": False, "default_enabled": False},
    ...
    {"key": "/report-center", "label": "数据应用中心", "section": "数据应用中心", "group": "数据展示", "required": False, "admin_only": False, "default_enabled": True},
...
API_PERMISSION_DEFINITIONS = [
    ...
    {"key": "reporting.manage", "label": "数据中心接口", "section": "集成中心", "group": "数据中心", "description": "允许维护外部连接、数据集模型和数据应用定义。", "admin_only": False, "default_enabled": False},
