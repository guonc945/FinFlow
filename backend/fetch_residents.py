...
MARKI_RESIDENT_API_ID = require_api_id("MARKI_RESIDENT_API_ID")
...
def sync_residents_for_community(community_id: str, task_id: str = None):
    ...
    base_url = get_api_url_by_id(MARKI_RESIDENT_API_ID)
    ...
    try:
        ...
        api_config = db_session.query(ExternalApi).filter(ExternalApi.id == MARKI_RESIDENT_API_ID).first()
