...
def test_sync_houses_for_community_continues_when_has_more_is_true():
    ...
    original_get_api_url_by_id = fetch_houses.get_api_url_by_id
    ...
    try:
        ...
        fetch_houses.get_api_url_by_id = lambda api_id: "https://example.test/getHouseList"
        ...
        fetch_houses.get_api_url_by_id = original_get_api_url_by_id
