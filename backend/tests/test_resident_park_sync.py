...
def test_sync_residents_for_community_uses_has_more_signal():
    ...
    original_get_api_url = fetch_residents.get_api_url
    ...
    try:
        ...
        fetch_residents.get_api_url = lambda api_name: "https://example.test/getUserList"
        ...
        fetch_residents.get_api_url = original_get_api_url
...
def test_sync_parks_for_community_stops_on_has_more_false():
    ...
    original_get_api_url = fetch_parks.get_api_url
    ...
    try:
        ...
        fetch_parks.get_api_url = lambda api_name: "https://example.test/getParkList"
        ...
        fetch_parks.get_api_url = original_get_api_url
