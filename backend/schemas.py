...
class ReportingTableColumnResponse(BaseModel):
    name: str
    type: str
...
class ReportingTableResponse(BaseModel):
    table_name: str
    schema_name: Optional[str] = None
    object_type: str = "table"
    columns: List[ReportingTableColumnResponse] = Field(default_factory=list)


class ReportingConnectionMetadataResponse(BaseModel):
    connection_id: int
    db_type: str
    database_name: str
    schema_name: Optional[str] = None
...
class ReportingDatasetValidationResponse(BaseModel):
    connection_id: int
    sql_text: str
    normalized_sql: str
...
class ReportingDatasetBase(BaseModel):
    ...
    row_limit: Optional[int] = Field(500, ge=1)
    is_active: Optional[bool] = True
...
class ReportingReportCategoryBase(BaseModel):
    name: str
    parent_id: Optional[int] = None
    sort_order: Optional[int] = 0
    status: Optional[int] = 1
...
class ReportingReportCategoryCreate(ReportingReportCategoryBase):
    pass


class ReportingReportCategoryUpdate(BaseModel):
    name: Optional[str] = None
    parent_id: Optional[int] = None
    sort_order: Optional[int] = None
    status: Optional[int] = None
...
class ReportingReportCategoryResponse(ReportingReportCategoryBase):
    id: int
    path: Optional[str] = None
    created_at: datetime
    updated_at: Optional[datetime] = None
    children: List["ReportingReportCategoryResponse"] = []
...
class ReportingReportDraftPreviewRequest(BaseModel):
    dataset_id: int
    report_type: str = "table"
    config_json: Optional[str] = None
    params: Dict[str, Any] = Field(default_factory=dict)
...
class DataDictionaryBase(BaseModel):
    key: str
    name: str
    dict_type: Literal["enum", "hierarchy"] = "enum"
    source_type: Literal["static", "dataset", "table", "sql"]
    config_json: str
    description: Optional[str] = None
    category: Optional[str] = "common"
    is_active: Optional[bool] = True
...
class DataDictionaryUpdate(BaseModel):
    key: Optional[str] = None
    name: Optional[str] = None
    dict_type: Optional[Literal["enum", "hierarchy"]] = None
    source_type: Optional[Literal["static", "dataset", "table", "sql"]] = None
    config_json: Optional[str] = None
    description: Optional[str] = None
    category: Optional[str] = None
    is_active: Optional[bool] = None
...
class DataDictionaryPreviewRequest(BaseModel):
    dict_type: Literal["enum", "hierarchy"] = "enum"
    source_type: Literal["static", "dataset", "table", "sql"]
    config_json: str
...
class DataDictionaryPreviewResponse(BaseModel):
    items: List[DataDictionaryItem]
    total: int
    columns: List[Dict[str, Any]] = Field(default_factory=list)
    rows: List[Dict[str, Any]] = Field(default_factory=list)


class BusinessDictionaryBase(BaseModel):
    key: str
    name: str
    dict_type: Literal["enum", "hierarchy"] = "enum"
    category: Optional[str] = "common"
...
class BusinessDictionaryCreate(BusinessDictionaryBase):
    pass


class BusinessDictionaryUpdate(BaseModel):
    key: Optional[str] = None
    name: Optional[str] = None
    dict_type: Optional[Literal["enum", "hierarchy"]] = None
    category: Optional[str] = None
...
class BusinessDictionaryResponse(BusinessDictionaryBase):
    id: int
    item_count: int = 0
    created_at: datetime
    updated_at: Optional[datetime] = None
...
class BusinessDictionaryItemBase(BaseModel):
    code: str
    label: str
    value: Optional[str] = None
    parent_id: Optional[int] = None
...
class BusinessDictionaryItemCreate(BusinessDictionaryItemBase):
    pass


class BusinessDictionaryItemUpdate(BaseModel):
    code: Optional[str] = None
...
class BusinessDictionaryItemResponse(BusinessDictionaryItemBase):
    id: int
    dictionary_id: int
    level: int = 1
    path: Optional[str] = None
    created_at: datetime
    updated_at: Optional[datetime] = None
    children: List["BusinessDictionaryItemResponse"] = Field(default_factory=list)

    model_config = ConfigDict(from_attributes=True)


class BusinessDictionaryResolveResponse(BaseModel):
    dictionary: BusinessDictionaryResponse
    items: List[BusinessDictionaryItemResponse] = Field(default_factory=list)
    tree: List[BusinessDictionaryItemResponse] = Field(default_factory=list)
